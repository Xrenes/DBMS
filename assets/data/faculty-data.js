...
const facultyData = {
  ...
  students: {
    CSE401: [
      { id: '2021-3-60-001', name: 'Iftekhar Hossain', section: 'A', attendance: 6, presentation: 7, assignment: 4, midExam: 20, final: null, quiz1: 12, quiz2: 13, quiz3: 11 },
      { id: '2021-3-60-002', name: 'Nusrat Jahan', section: 'A', attendance: 7, presentation: 8, assignment: 5, midExam: 22, final: null, quiz1: 14, quiz2: 15, quiz3: 13 },
      { id: '2021-3-60-003', name: 'Tanvir Ahmed', section: 'A', attendance: 5, presentation: 5, assignment: 3, midExam: 15, final: null, quiz1: 9, quiz2: 10, quiz3: 8 },
      { id: '2021-3-60-004', name: 'Farida Begum', section: 'A', attendance: 7, presentation: 7, assignment: 5, midExam: 24, final: null, quiz1: 14, quiz2: 15, quiz3: 14 },
      { id: '2021-3-60-005', name: 'Raihan Islam', section: 'A', attendance: 4, presentation: 5, assignment: 3, midExam: 14, final: null, quiz1: 8, quiz2: 7, quiz3: 9 },
      { id: '2021-3-60-006', name: 'Sadia Sultana', section: 'A', attendance: 6, presentation: 7, assignment: 4, midExam: 21, final: null, quiz1: 12, quiz2: 11, quiz3: 13 },
      { id: '2021-3-60-007', name: 'Anik Chowdhury', section: 'A', attendance: 5, presentation: 6, assignment: 4, midExam: 18, final: null, quiz1: 10, quiz2: 12, quiz3: 11 },
      { id: '2021-3-60-008', name: 'Mitu Akter', section: 'A', attendance: 7, presentation: 8, assignment: 5, midExam: 24, final: null, quiz1: 14, quiz2: 15, quiz3: 14 },
    ],
    CSE405: [
      { id: '2021-3-60-001', name: 'Iftekhar Hossain', section: 'A', attendance: 6, presentation: 7, assignment: 4, midExam: 21, final: 35, quiz1: 13, quiz2: 12, quiz3: 14 },
      { id: '2021-3-60-009', name: 'Sajid Mahmud', section: 'A', attendance: 5, presentation: 6, assignment: 4, midExam: 17, final: 28, quiz1: 10, quiz2: 11, quiz3: 12 },
      { id: '2021-3-60-010', name: 'Rimi Khatun', section: 'A', attendance: 7, presentation: 8, assignment: 5, midExam: 25, final: 38, quiz1: 15, quiz2: 14, quiz3: 15 },
      { id: '2021-3-60-011', name: 'Shanto Barua', section: 'A', attendance: 3, presentation: 4, assignment: 2, midExam: 12, final: 18, quiz1: 6, quiz2: 7, quiz3: 8 },
      { id: '2021-3-60-012', name: 'Puja Das', section: 'A', attendance: 7, presentation: 7, assignment: 5, midExam: 23, final: 36, quiz1: 14, quiz2: 13, quiz3: 15 },
    ],
    CSE301: [
      { id: '2022-3-60-001', name: 'Habib Ullah', section: 'C', attendance: 5, presentation: 6, assignment: 4, midExam: 19, final: null, quiz1: 11, quiz2: 12, quiz3: 10 },
      { id: '2022-3-60-002', name: 'Sumaiya Islam', section: 'C', attendance: 7, presentation: 7, assignment: 5, midExam: 22, final: null, quiz1: 13, quiz2: 14, quiz3: 12 },
      { id: '2022-3-60-003', name: 'Rafiq Hasan', section: 'C', attendance: 5, presentation: 5, assignment: 3, midExam: 16, final: null, quiz1: 9, quiz2: 10, quiz3: 11 },
    ],
  },
  ...
  attendanceSessions: {
    CSE401: {
      ...
      students: [
        ...
        { id: '2021-3-60-005', name: 'Raihan Islam', status: 'A', totalPresent: 13 },
