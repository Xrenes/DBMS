...
const API = {
  ...
  evaluation: {
    async getForms() {
      return API.get('/evaluation/forms');
    },
    async getSummary() {
      return API.get('/evaluation/summary');
    },
    async submit(data) {
      return API.post('/evaluation/submit', data);
    },
    async createForm(data) {
      return API.post('/evaluation/forms', data);
    }
  },
  ...
  faculty: {
    ...
    async getCourses(semesterId) {
      ...
      return API.get(`/faculty/courses${qs}`);
    },
    async getCourseStudents(offeringId) {
      return API.get(`/faculty/courses/${offeringId}/students`);
    },
    async getRoutine() {
      return API.get('/faculty/routine');
    },
    async getList() {
      return API.get('/faculty/list');
    },
  ...
  leave: {
    ...
    async updateStatus(id, status, comments) {
      return API.put(`/leave/${id}/status`, { status, comments });
    }
  },
  ...
  registration: {
    ...
    async getItems(id) {
      return API.get(`/registration/${id}/items`);
    },
    async create(data) {
      return API.post('/registration', data);
    },
    async submit(id) {
      return API.put(`/registration/${id}/submit`, {});
    },
    async updateStatus(id, status) {
      return API.put(`/registration/${id}/status`, { status });
    }
  },
  ...
  clearance: {
    async getAll() {
      return API.get('/clearance');
    },
    async getSteps(id) {
      return API.get(`/clearance/${id}/steps`);
    },
    async request(data) {
      return API.post('/clearance', data);
    },
    async updateStep(stepId, status, remarks) {
      return API.put(`/clearance/steps/${stepId}`, { status, remarks });
    }
  }
};
