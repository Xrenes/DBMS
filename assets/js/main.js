...
function handleLogout() {
  if (confirm('Are you sure you want to logout?')) {
    ...
    localStorage.removeItem('portal_student_type');
...
function updateUserInfo() {
  ...
  if (sidebarUserRole) sidebarUserRole.textContent = profile.program || 'B.Sc. CSE';
  ...
  if (headerUserRole) {
    const sem = profile.currentSemester || 0;
    headerUserRole.textContent = sem > 0 ? 'Semester ' + sem : 'New Student';
  }
